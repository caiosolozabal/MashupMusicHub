                ...
                <CardContent className="space-y-8">
                    ...
                    <div className="space-y-4 p-4 border rounded-lg bg-secondary/50">
                        ...
                        <Alert variant="default" className='bg-background'>
                            ...
                            <AlertDescription>
                                Esta ferramenta se conecta ao banco de dados antigo (`listeiro-cf302`) para encontrar e importar apenas os eventos que não existem no banco atual, evitando duplicatas.
                            </AlertDescription>
                        </Alert>
